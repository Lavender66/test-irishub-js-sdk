 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.authz.v1beta1.MsgGrantResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.authz.v1beta1.MsgExecResponse)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.authz.v1beta1.MsgRevokeResponse)}
 *     callback The callback function(error, response)
