 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.irismod.coinswap.QueryLiquidityPoolResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.irismod.coinswap.QueryLiquidityPoolsResponse)}
 *     callback The callback function(error, response)
