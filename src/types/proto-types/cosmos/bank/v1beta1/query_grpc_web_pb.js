 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.bank.v1beta1.QueryDenomMetadataResponse)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.bank.v1beta1.QueryDenomsMetadataResponse)}
 *     callback The callback function(error, response)
