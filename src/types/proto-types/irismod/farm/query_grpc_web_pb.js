 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.irismod.farm.QueryFarmPoolsResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.irismod.farm.QueryFarmPoolResponse)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.irismod.farm.QueryFarmerResponse)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.irismod.farm.QueryParamsResponse)}
 *     callback The callback function(error, response)
